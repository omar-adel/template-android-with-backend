...
app.get('/', function(req, res){
     ...
     var sql = 'SELECT * FROM courses LEFT JOIN course_sections ON course_sections.course_id = courses.id';
    var sqlrepo = 'SELECT * FROM courses LEFT JOIN course_sections ON course_sections.course_id = courses.id LEFT JOIN departments ON departments.id = courses.department_id LEFT JOIN course_terms ON course_sections.courseterm_id = course_terms.id';
    ...
    var nestingOptions = [
        ...
        { tableName : 'course_sections', pkey: 'id', fkeys:[{table:'courses',col:'course_id'}
        ]},
    ];
  //Key relations, Define each table's primary and foreign keys
    var nestingOptionsrepo = [
        { tableName : 'courses', pkey: 'id', fkeys:[{table:'departments',col:'department_id'}]},
