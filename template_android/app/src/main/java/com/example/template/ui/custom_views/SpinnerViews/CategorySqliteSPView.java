...
public class CategorySqliteSPView extends LinearLayout {
    ...
    public CategorySqliteSPView(Context context, Object o, int type) {
        super(context);
    ...
    private void drawData(Object o, Context context, int type) {
        CategoriesWithOutItemsQueryModel category = (CategoriesWithOutItemsQueryModel) o;
        if (type == 0)
            spinner_txtv_item.setText(category.getName());
        else
            spinner_drop_txtv_item.setText(category.getName());
    }
